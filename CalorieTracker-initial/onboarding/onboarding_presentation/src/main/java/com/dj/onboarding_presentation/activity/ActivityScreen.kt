package com.dj.onboarding_presentation.activity
...
import com.dj.onboarding_presentation.components.SelectableButton
    ...
    Box(
        ...
        Column(
            ...
            Row {
                ...
                Spacer(
                    modifier = Modifier.width(width = spacing.spaceMedium)
                )
                SelectableButton(
